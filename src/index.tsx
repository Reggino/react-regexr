...
const Test = () => {
  ...
  const handleIncludePatternChange = React.useCallback((value: string) => {
    setIncludePattern(value);
  }, []);

  const handleShouldMatchChange = React.useCallback((value: string) => {
    setShouldMatchText(value);
  }, []);

  const handleExcludePatternChange = React.useCallback((value: string) => {
    setExcludePattern(value);
  }, []);

  const handleShouldNotMatchChange = React.useCallback((value: string) => {
