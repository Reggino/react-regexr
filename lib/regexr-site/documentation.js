var library = {
	...
	kids: [{
		...
		kids: [{
			...
			desc: "Check out the three minute video tutorial for a quick introduction to all the features of RegExr." + "<p><a href='javascript:regexr.showVideo();'>Click here</a> to watch the video.</p>"
		}, {
			label: "About",
			...
			desc: "This is where you enter a regular expression to test. The results in the <b>Text</b> panel will update as you type. Roll over the expression for information on each token." + "<p>The buttons to the right allow you to save & share your pattern, or edit the expression flags. Saved patterns can be updated for 24hrs.</p>" + "<p>The results bubble will show the number of matches, or indicate errors.</p>"
		}, {
			label: "Text panel",
			...
			label: "Tools panel",
			desc: "Click the <b>Tools</b> title bar below the <b>Text</b> panel to show or hide the <b>Tools</b> panel." + "<p>Tools provide different ways of working with or investigating your results.</p>",
			kids: [{
				label: "Replace",
				desc: "The <b>Replace</b> tool replaces matches with a specified string or pattern." + "<p>Matches in the <b>Text</b> panel are replaced by the substitution string & displayed as you type.</p>" + "<p><a href='javascript:showLib(\"subst\")'>Substitution tokens</a> (ex. <code>$&</code> or <code>$1</code>) and escaped characters compatible with the JS string format are supported, such as <code>\\n</code>, <code>\\t</code> & <code>\\u0009</code>.</p>" + "<p>Roll over tokens for information.</p>"
			}, {
				label: "List",
				desc: "The <b>List</b> tool lists all found matches." + "<p>You can specify either a simple delimiter (ex. <code>,</code> or <code>\\n</code>), or use <a href='javascript:showLib(\"subst\")'>substitution tokens</a> to generate more advanced reports. For example, <code>$1\\n</code> would list all group 1 results.</p>" + "<p>Escaped characters compatible with the JS string format are supported, such as <code>\\n</code>, <code>\\t</code> & <code>\\u0009</code>.</p>" + "<p>Roll over tokens for information.</p>"
			}, {
				label: "Details",
				desc: "The <b>Details</b> tool displays the full text of a match and it's capture groups." + "<p>Click on a highlighted match in the <b>Text</b> panel to display details for that match.</p>"
			}, {
				label: "Explain",
				desc: "The <b>Explain</b> tool displays a detailed breakdown of the <b>Expression</b>." + "<p>Mouse over the explanation to highlight the related tokens in the <b>Expression</b> panel.</p>"
			}]
		}, {
			label: "Library panel",
			desc: "The <b>Library</b> (this panel) includes <b>help</b> content and a <b>reference</b> that includes info on all regular expression tokens and flags." + "<p>Tap a selected item in the reference to insert it into your <b>Expression</b>. Click the <span class='icon'>&#xE212;</span> beside an example to load it.</p>" + "<p>The library also includes <b>example</b> patterns, searchable <b>community</b> submissions, and your saved <b>favourites</b>.</p>"
		}]
	}, {
		label: "Reference",
		id: "reference",
		...
		id: "examples",
		icon: "&#xE065;",
		desc: "Example patterns to get you started with Regular Expressions." + "<p>Click the <span class='icon'>&#xE212;</span> beside an example to load it.</p>",
		kids: [{
